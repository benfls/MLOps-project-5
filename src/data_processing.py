...
class DataProcessing:
    ...
    def preprocess_data(self):
        try:
            ...
            logger.error(f"Error in Basic preprocessing data: {e}")
            raise CustomException(f"Error in Basic preprocessing data")
    ...
    def feature_selection(self):
        try:
            ...
            raise CustomException(f"Error in feature selection")
    ...
    def split_and_scale_data(self):
        try:
            ...
            logger.error(f"Error in splitting and scaling data: {e}")
            raise CustomException(f"Error in splitting and scaling data")
    ...
    def save_data_and_scaler(self, X_train, X_test, y_train, y_test):
        try:
            ...
            logger.error(f"Error in saving data and scaler: {e}")
            raise CustomException(f"Error in saving data and scaler")
    ...
    def run(self):
        try:
            ...
            raise CustomException(f"Error in data processing")
